...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest pa-paletavegetal.client -- --template=react  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`pa-paletavegetal.client.esproj`).
